...
(define rust-armv7-0.2.1.e37a72f
  ...
  (origin
    ...
    (file-name (git-file-name "rust-armv7" "0.2.1.e37a72f"))
...
(define rust-atsama5d27-0.1.0.9e83a50
  ;; TODO REVIEW: Define standalone package if this is a workspace.
  (origin
    (method git-fetch)
    (uri (git-reference
    ...
    (file-name (git-file-name "rust-atsama5d27" "0.1.0.9e83a50"))
    (sha256 (base32 "0gjfcrn8dia0nqag035c431qaxw7qa13h8mb17kwgbfkabg2w6b9"))
    (snippet bao-atsama5d27-snippet)))
...
(define rust-bao1x-api-0.1.2
  (crate-source "bao1x-api" "0.1.2"
                "15a41v5l5wrm1dmq041d07zcycbsx4wvn6q6zr8x65xjgh9wbvd4"))
...
(define rust-com-rs-0.1.0.891bdd3
  ;; TODO REVIEW: Define standalone package if this is a workspace.
  (origin
    (method git-fetch)
    (uri (git-reference
    ...
    (file-name (git-file-name "rust-com-rs" "0.1.0.891bdd3"))
...
(define rust-curve25519-dalek-4.1.2.16e087a
  ;; TODO REVIEW: Define standalone package if this is a workspace.
  (origin
    (method git-fetch)
    (uri (git-reference
          (url "https://github.com/betrusted-io/curve25519-dalek.git")
          (commit "16e087ab969a5d3f4099fddca97ac6dbba82bd66")))
    (file-name (git-file-name "rust-curve25519-dalek" "4.1.2.16e087a"))
    (sha256 (base32 "05vqdg88assma2c4myh8vnhs99vc7ng01f8dmaxn6hbcjqi9n3d4"))))
...
(define rust-curve25519-dalek-derive-0.1.1.16e087a
  ;; TODO REVIEW: Define standalone package if this is a workspace.
  (origin
    (method git-fetch)
    (uri (git-reference
          (url "https://github.com/betrusted-io/curve25519-dalek.git")
          (commit "16e087ab969a5d3f4099fddca97ac6dbba82bd66")))
    (file-name (git-file-name "rust-curve25519-dalek-derive" "0.1.1.16e087a"))
    (sha256 (base32 "05vqdg88assma2c4myh8vnhs99vc7ng01f8dmaxn6hbcjqi9n3d4"))))
...
(define rust-engine-25519-0.1.0.63d3d1f
  ;; TODO REVIEW: Define standalone package if this is a workspace.
  (origin
    (method git-fetch)
    (uri (git-reference
    ...
    (file-name (git-file-name "rust-engine-25519" "0.1.0.63d3d1f"))
    (sha256 (base32 "15792rdkn2lzg35cj9c122bkhbwm248p9mqrv34811y8fhxf4v6l"))))

(define rust-engine25519-as-0.1.0.775e840
  ;; TODO REVIEW: Define standalone package if this is a workspace.
  (origin
    (method git-fetch)
    (uri (git-reference
    ...
    (file-name (git-file-name "rust-engine25519-as" "0.1.0.775e840"))
...
(define rust-keccak-0.2.0
  (crate-source "keccak" "0.2.0"
                "1alql41qwrb6q2zw6358wvr1pd0m50c56liyh3nxfns0vl8a094y"))
...
(define rust-ring-0.17.7.5f86cb1
  ;; TODO REVIEW: Define standalone package if this is a workspace.
  (origin
    (method git-fetch)
    (uri (git-reference
    ...
    (file-name (git-file-name "rust-ring" "0.17.7.5f86cb1"))
...
(define rust-rqrr-0.10.0.388fc6c
  ;; TODO REVIEW: Define standalone package if this is a workspace.
  (origin
    (method git-fetch)
    (uri (git-reference
    ...
    (file-name (git-file-name "rust-rqrr" "0.10.0.388fc6c"))
    (sha256 (base32 "0il0cr1wpkj32f1bih4xq2bbf2iwanmlavlq9f6ls0c80qn6vz1d"))
    (snippet bao-rqrr-snippet)))
...
(define rust-sha2-0.10.8.161da48
  ;; TODO REVIEW: Define standalone package if this is a workspace.
  (origin
    (method git-fetch)
    (uri (git-reference
          (url "https://github.com/betrusted-io/hashes.git")
          (commit "161da48eb94ba61108634b240a1f30f185779a37")))
    (file-name (git-file-name "rust-sha2" "0.10.8.161da48"))
    (sha256 (base32 "1r86mq3jildaaw6xhdm9fpl8b61sj93avyqy18pc1rlrxxj657vk"))))
...
(define rust-shake-0.1.0
  (crate-source "shake" "0.1.0"
                "0jkwjihnygh6qdlrq8i1jhhm9hx4z58v69hyvb9cpm4s2jr7q189"))
...
(define rust-simple-fatfs-0.1.0-alpha.1.83b886a
  ;; TODO REVIEW: Define standalone package if this is a workspace.
  (origin
    (method git-fetch)
    (uri (git-reference
    ...
    (file-name (git-file-name "rust-simple-fatfs" "0.1.0-alpha.1.83b886a"))
...
(define rust-sponge-cursor-0.1.0
  (crate-source "sponge-cursor" "0.1.0"
                "0836pjdf7sdsy5hpzpgsvzpqp7xcw6azchagb8j5i7cpgnyij0is"))
...
(define rust-usb-device-0.2.8.7ab6ba8
  ;; TODO REVIEW: Define standalone package if this is a workspace.
  (origin
    (method git-fetch)
    (uri (git-reference
    ...
    (file-name (git-file-name "rust-usb-device" "0.2.8.7ab6ba8"))
...
(define rust-usbd-serial-0.1.1.c20edaf
  ;; TODO REVIEW: Define standalone package if this is a workspace.
  (origin
    (method git-fetch)
    (uri (git-reference
    ...
    (file-name (git-file-name "rust-usbd-serial" "0.1.1.c20edaf"))
...
(define rust-utralib-0.1.18.9e83a50
  ;; TODO REVIEW: Define standalone package if this is a workspace.
  (origin
    (method git-fetch)
    (uri (git-reference
          (url "https://github.com/Foundation-Devices/atsama5d27.git")
          (commit "9e83a502e68384754bb328a5717c56f34c8618f7")))
    (file-name (git-file-name "rust-utralib" "0.1.18.9e83a50"))
    (sha256 (base32 "0gjfcrn8dia0nqag035c431qaxw7qa13h8mb17kwgbfkabg2w6b9"))))
...
(define rust-xous-semver-0.1.6
  (crate-source "xous-semver" "0.1.6"
                "0q9pxbf0hvq4y0gp1kc63q68yx43x5bpcj5qxflnlskwa9l52l20"))
...
(define rust-xous-usb-hid-0.4.3.793ec00
  ;; TODO REVIEW: Define standalone package if this is a workspace.
  (origin
    (method git-fetch)
    (uri (git-reference
    ...
    (file-name (git-file-name "rust-xous-usb-hid" "0.4.3.793ec00"))
    (sha256 (base32 "172bw2p6hj3478ns5c06nlwy1hqflrhz3ngnmriy7zxp4bpqsr5y"))
    (snippet bao-xous-usb-hid-snippet)))
...
(define-cargo-inputs lookup-cargo-inputs
                     (locales =>
                              (list rust-aho-corasick-0.7.18
                                    ...
                                    rust-ryu-1.0.9
                                    rust-serde-1.0.135
                                    rust-serde-json-1.0.78
                                    rust-unicode-xid-0.2.2))
                     (xous-core =>
                                (list rust-adler-1.0.2
                                 ...
                                 rust-atsama5d27-0.1.0.9e83a50
                                 rust-atty-0.2.14
                                 rust-autocfg-1.1.0
                                 rust-az-1.2.1
                                 rust-bao1x-api-0.1.2
                                 ...
                                 rust-ctr-0.10.1
                                 rust-ctutils-0.4.2
                                 rust-curve25519-dalek-4.1.2.16e087a
                                 rust-curve25519-dalek-derive-0.1.1
                                 rust-curve25519-dalek-derive-0.1.1.16e087a
                                 rust-darling-0.13.4
                                 rust-darling-0.20.5
                                 ...
                                 rust-ena-0.14.2
                                 rust-engine-25519-0.1.0.63d3d1f
                                 rust-engine25519-as-0.1.0.775e840
                                 ...
                                 rust-simple-fatfs-0.1.0-alpha.1.83b886a
                                 ...
                                 rust-xous-semver-0.1.6
                                 rust-xous-tts-backend-0.1.6
                                 rust-xous-usb-hid-0.4.3.793ec00
                                 rust-zero-0.1.3
