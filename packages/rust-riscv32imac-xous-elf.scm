;;; GNU Guix package definition for Xous sysroot
;;;
;;; This module provides the Xous sysroot for building Xous applications
;;; targeting riscv32imac-unknown-xous-elf.

(define-module (rust-riscv32imac-xous-elf)
  ...
  #:use-module (rust)
  #:use-module (rust-crates-sysroot))
